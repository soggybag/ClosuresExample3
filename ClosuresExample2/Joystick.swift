...
The Joystick draws itself as two layers. A larger circle, the joystick, outlining the 
range of the Joystick,
and a smaller circle that follows your finger, this is the stick. The stick is a child 
of joystick.
...
class Joystick: SKNode {
    ...
    // Exercise add a var to hold an closure, invoke the closure in move()
